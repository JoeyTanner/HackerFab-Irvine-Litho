...
clr.AddReference('DLPComposer.Commands.DLPC347x.Dual')
from DLPComposer.Commands.DLPC347x.Dual import *
clr.AddReference('DLPComposer.IO.Communications')
from DLPComposer.IO.Communications import DLPC347xDualCommunicationManager as CommunicationManager
clr.AddReference('DLPComposer.Registers')
from DLPComposer.Registers import RegisterBase
