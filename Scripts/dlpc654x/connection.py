...
from DLPComposer.IO.DLPC754x import USBBulkCommandInterface, USBHIDCommandInterface, I2CCommandInterface
...
def usb_connect(vid=0x451, pid=0x7540):
    _disconnect()
    available_usb_interfaces = WinUSBCommandInterface.GetAvailableInterfaces()
